...
inspoxy36_trach <- box_plot(newdata, Tracheostomy, inspired_oxygen.36, "Fraction of Inspired Oxygen at 36 weeks")
peak36_trach <- box_plot(newdata, Tracheostomy, p_delta.36, "Peak Inspiratory Pressure (cmH2O) at 36 weeks")
posexp36_trach <- box_plot(newdata, Tracheostomy, peep_cm_h2o_modified.36, "Positive and exploratory pressure (cm H2O) at 36 weeks")

plot1 <- ggarrange(bw36_trach, inspoxy36_trach, peak36_trach, posexp36_trach,
                   ncol = 4, nrow = 1)
annotate_figure(plot1, top = text_grob("Boxplots for Continuous Independent Respiratory Support Variables", color = "black", face = "bold", size = 14))
...
inspoxy44_trach <- box_plot(newdata2, Tracheostomy, inspired_oxygen.44, "Fraction of Inspired Oxygen at 44 weeks")
peak44_trach <- box_plot(newdata2, Tracheostomy, p_delta.44, "Peak Inspiratory Pressure (cmH2O) at 44 weeks")
posexp44_trach <- box_plot(newdata2, Tracheostomy, peep_cm_h2o_modified.44, "Positive and exploratory pressure (cm H2O) at 44 weeks")
plot2 <- ggarrange(bw44_trach, inspoxy44_trach, peak44_trach, posexp44_trach,
                   ncol = 4, nrow = 1)
annotate_figure(plot2, top = text_grob("Boxplots for Continuous Independent Respiratory Support Variables", color = "black", face = "bold", size = 14))
